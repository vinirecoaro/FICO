...
class ExpenseListAdapter(private var expenseList: List<Expense>, private val earningList : List<Earning>, private val categories : List<TransactionCategory>) : RecyclerView.Adapter<ExpenseListAdapter.ViewHolder>(){
